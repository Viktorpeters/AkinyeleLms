  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      ...
      if (
        ...
        !getInvolvedRef.current.contains(e.target as Node)
      )
  ...
  return (
    <header className={`${styles.header} ${isScrolled ? styles.scrolled : ""}`}>
      ...
      <div className={styles.logo}>
        <Link href="/">
          <Image
            src="https://res.cloudinary.com/ddlnqthao/image/upload/v1758740543/image_1_yzxeal.png"
            alt="Church logo"
            height={50}
            width={70}
            priority
      ...
      <nav className={styles.nav} aria-label="Main navigation">
        ...
        className={`${styles.navList} ${
          isScrolled ? styles.navListScrolled : ""
        }`}
      >
          {/* Courses */}
          <li  className={`${styles.dropdown} ${
          isScrolled ? styles.dropdownScrolled : ""
        }`} ref={coursesRef}>
            <button
              className={`${styles.dropdownTrigger} ${
                showCoursesDesktop ? styles.active : ""
              }`}
          ...
          {/* Get Involved */}
          <li  className={`${styles.dropdownn} ${
          isScrolled ? styles.dropdownScrolled : ""
        }`} ref={getInvolvedRef}>
            <button
              className={`${styles.dropdownTriggerr} ${
                showGetInvolvedDesktop ? styles.active : ""
              }`}
      ...
      <div className={styles.actions}>
        ...
        <Link href="/signup">
          <button className={styles.secondaryBtnn}>Join Now</button>
        </Link>
      </div>
      ...
      >
        ...
        <ul className={styles.mobileNavList}>
          ...
          <li>
            <button
              className={`${styles.mobileDropdownTrigger} ${
                showCoursesMobile ? styles.active : ""
              }`}
              onClick={() => {
            ...
            >
              ...
              <ChevronDown
                className={`${styles.chevron} ${
                  showCoursesMobile ? styles.rotate : ""
                }`}
              />
            </button>
            {showCoursesMobile && (
          ...
          <li>
            <button
              className={`${styles.mobileDropdownTrigger} ${
                showGetInvolvedMobile ? styles.active : ""
              }`}
              onClick={() => {
            ...
            >
              ...
              <ChevronDown
                className={`${styles.chevron} ${
                  showGetInvolvedMobile ? styles.rotate : ""
                }`}
              />
            </button>
          ...
          <li>
            <Link href="/signup">
              <button className={styles.secondaryBtn}>Join Now</button>
            </Link>
          </li>
        </ul>
      </div>
